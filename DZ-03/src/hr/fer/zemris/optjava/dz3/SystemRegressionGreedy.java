...
import hr.fer.zemris.optjava.dz3.algorithm.GreedyAlgorithm;
...
public class SystemRegressionGreedy {
	...
	public static void main(String[] args) throws IOException {
		...
		algorithm = new GreedyAlgorithm<SingleObjectiveSolution>(decoder, neighbourhood, solution, function, true);
